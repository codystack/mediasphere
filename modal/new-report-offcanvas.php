                <div class="offcanvas offcanvas-end w-full w-lg-2/3" data-bs-scroll="true" data-bs-backdrop="true" tabindex="-1" id="offcanvasAddNewReport" aria-labelledby="offcanvasAddNewReportLabel">
                    <div class="offcanvas-header border-bottom py-4 bg-surface-secondary">
                        <h5 class="offcanvas-title" id="offcanvasAddNewReportLabel">New Report</h5>
