<div class="offcanvas offcanvas-end w-full w-lg-1/2" data-bs-scroll="true" data-bs-backdrop="true" tabindex="-1" id="offcanvasAddNewRequest" aria-labelledby="offcanvasAddNewRequestLabel">
    <div class="offcanvas-header border-bottom py-4 bg-surface-secondary">
        <h5 class="offcanvas-title" id="offcanvasAddNewRequestLabel">New Request</h5>
        ...
        <form id="requestForm" method="POST" enctype="multipart/form-data">
            <div class="row g-5">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="request_title" required placeholder="Request title">
                </div>
